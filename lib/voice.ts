...
// ---------------------------------------------------------------------------
// IABTM's own vocabulary, verbatim.
// ---------------------------------------------------------------------------
// Every label below is an exact string from the live IABTM platform's
// Settings → Attributes screen ("Attributes of Current Self" and "Attributes
// of Self You Imagine"). We deliberately do NOT invent our own adjectives:
// when the coach says it heard "Burnt Out" and is steering you toward
// "Balanced", those are the same chips the user can select in their IABTM
// profile — so the agent is reasoning in the host platform's language, and a
// future integration can read/write these attributes directly with no mapping
// layer.
// ---------------------------------------------------------------------------

/** Spoken cue -> IABTM "Attributes of Current Self". Any hit means low energy. */
const LOW_ENERGY: Record<string, string> = {
  ...
  stuck: "Blocked",
  blocked: "Blocked",
  "creatively stuck": "Creatively Stuck",
  "can't create": "Creatively Stuck",
  "cant create": "Creatively Stuck",
  "no ideas": "Creatively Stuck",
  frustrated: "Bitter",
  resentful: "Bitter",
  ...
  foggy: "Absent-minded",
  "can't focus": "Absent-minded",
  "cant focus": "Absent-minded",
  unfocused: "Absent-minded",
  procrastinat: "Avoidant",
  avoiding: "Avoidant",
  "putting off": "Avoidant",
  "afraid of failing": "Afraid Of Failure",
  "afraid to fail": "Afraid Of Failure",
  "scared i'll fail": "Afraid Of Failure",
  afraid: "Afraid",
  scared: "Afraid",
  ashamed: "Ashamed",
  embarrassed: "Ashamed",
  "behind everyone": "Ashamed",
  doomscroll: "Consumed",
  "doom scroll": "Consumed",
  "wasting time": "Consumed",
  consumed: "Consumed",
  defensive: "Defensive",
};

/** Spoken cue -> IABTM "Attributes of Self You Imagine" (already-high states). */
const HIGH_ENERGY: Record<string, string> = {
  motivated: "Action-oriented",
  ready: "Action-oriented",
  "let's go": "Action-oriented",
  "lets go": "Action-oriented",
  excited: "Active",
  energized: "Active",
  energetic: "Active",
  pumped: "Bold",
  "fired up": "Bold",
  inspired: "Adventurous",
  curious: "Adventurous",
};

/** Explicitly voiced "Attributes of Self You Imagine". */
const IMAGINED: Record<string, string> = {
  ...
  athletic: "Athletic",
  abundant: "Abundant",
  "actualize my dreams": "Actualize My Dreams",
  "great business person": "A Great Business Person",
  "better parent": "A Better Parent",
};

/**
 * Where a Current-Self attribute wants to go when the user didn't name a
 * destination. Both sides are exact IABTM chip labels, so this table is
 * literally "Attributes of Current Self → Attributes of Self You Imagine".
 */
const CURRENT_TO_IMAGINED: Record<string, string> = {
  ...
  Busy: "Aligned",
  Anxious: "Calm",
  Blocked: "Action-oriented",
  "Creatively Stuck": "Adaptable",
  Bitter: "Accepting",
  Apathetic: "Active",
  Complacent: "Adventurous",
  Comfortable: "Bold",
  Chaotic: "Centered",
  "Absent-minded": "Alert",
  Avoidant: "Accountable",
  "Afraid Of Failure": "Brave",
  Afraid: "Brave",
  Ashamed: "Accepting",
  Consumed: "Aware",
  Defensive: "Accepting",
