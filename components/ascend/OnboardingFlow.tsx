...
const TIME_OPTIONS: { value: 15 | 30 | 60; label: string; sub: string }[] = [
...
export function OnboardingFlow({ onComplete }: Props) {
  ...
  const [dailyTime, setDailyTime] = useState<15 | 30 | 60 | null>(null);
                    ...
                    {INTEREST_OPTIONS.map((opt, idx) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className={cn("text-caption", selected ? "text-background/70" : "text-muted-foreground")}>
                            {opt.hint}
                          </div>
                        </motion.button>
                      );
